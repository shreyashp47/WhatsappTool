...
import com.cotrav.printyou.adapter.ColorPickerAdapter;
import com.cotrav.printyou.adapter.FontPickerAdapter;
...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManagerf = new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
        addTextFontPickerRecyclerView.setLayoutManager(layoutManagerf);
