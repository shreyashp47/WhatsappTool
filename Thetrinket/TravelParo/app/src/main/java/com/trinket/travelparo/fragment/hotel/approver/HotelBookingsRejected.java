...
public class HotelBookingsRejected extends Fragment implements SwipeRefreshLayout.OnRefreshListener,HotelBookingsCompletedRejectedAdapter.OnLastLocationReachedListener {
    private static final String TAG = HotelBookingsRejected.class.getSimpleName();
    private RecyclerView recyclerView;
    private SwipeRefreshLayout swipeRefreshLayout;
    private ApproverInfoViewModel approverInfoViewModel;
    private HotelBookingViewModel hotelBookingViewModel;
    private ArrayList<HotelBooking> rejectedHotelBookings;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rejectedHotelBookings =new ArrayList<>();
        ...
        hotelBookingsCompletedRejectedAdapter
                = new HotelBookingsCompletedRejectedAdapter(getActivity(),rejectedHotelBookings,this);
        ...
        hotelBookingViewModel.getRejectedBookingList(approverInfoViewModel.getAccessToken().getValue(),approverInfoViewModel.getAuthType().getValue(),"rejected",String.valueOf(pageNo))
                .observe(this, new Observer<List<HotelBooking>>() {
                    ...
                    public void onChanged(@Nullable List<HotelBooking> bookings) {
                        ...
                        if (bookings != null && pageNo == 1) {
                            rejectedHotelBookings.clear();
                            rejectedHotelBookings.addAll(bookings);
        ...
        hotelBookingViewModel.getCancelledError().observe(this, new Observer<String>() {
            @Override
        ...
        hotelBookingViewModel.getHasMoreCancelledBookings().observe(this, new Observer<Boolean>() {
            @Override
