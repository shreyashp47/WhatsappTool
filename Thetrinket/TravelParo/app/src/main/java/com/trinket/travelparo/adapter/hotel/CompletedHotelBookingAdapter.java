...
public class CompletedHotelBookingAdapter extends RecyclerView.Adapter<CompletedHotelBookingAdapter.ViewHolder> {

    OnLastLocationReachedListener onLastLocationReachedListener;
    List<Booking> bookingList;
    OnDetailsClickedListener onDetailsClickedListener;

    public CompletedHotelBookingAdapter(Fragment fragment, List<Booking> bookingList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CompletedHotelBookingAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.status_listview_layout_hotel,parent,false));
