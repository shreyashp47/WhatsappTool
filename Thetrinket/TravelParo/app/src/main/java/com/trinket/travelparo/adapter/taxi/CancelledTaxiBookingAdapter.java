...
public class CancelledTaxiBookingAdapter extends RecyclerView.Adapter<CancelledTaxiBookingAdapter.ViewHolder> {

    List<Booking> bookingList;
    CancelledTaxiBookingAdapter.OnLastLocationReachedListener lastLocationReachedListener;
    OnDetalisClickedListener onDetalisClickedListener;


    public CancelledTaxiBookingAdapter(Fragment fragment, List<Booking> bookingList) {
        this.bookingList = bookingList;
        this.lastLocationReachedListener = (OnLastLocationReachedListener)fragment;
        this.onDetalisClickedListener=(OnDetalisClickedListener)fragment;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CancelledTaxiBookingAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.status_listview_layout, parent, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()){
                case R.id.btn_detail: onDetalisClickedListener.onDetailsClicked(bookingList.get(pos).getId());
                    break;
            }
    ...
    public interface OnDetalisClickedListener{
