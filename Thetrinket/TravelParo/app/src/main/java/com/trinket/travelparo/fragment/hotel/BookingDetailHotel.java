...
import com.taxivaxi.spoc.model.hotelbookingdetaismodel.HotelBookingDetail;
...
/**
 * Created by linxterminal on 27/2/17.
 */

public class BookingDetailHotel extends Fragment implements View.OnClickListener{
    JSONObject bookings;
    LinearLayout emp_lay1,emp_lay2,emp_lay3,emp_lay4,emp_lay5,emp_lay6,driver_lay,texi_lay,ticket_lay,assesmenlay,hotel_ticket,lay_ticketno,
            lay_operator_name,lay_bus_type,lay_operator_contact,lay10,lay11,lay5,lay12,lay13,lay14,
            feedbackLay1,feedbackLay2,feedbackLay3,feedbackLay4,feedbackLay5,feedbackLay6,feedbackLay,downloadTicketLay;
    TextView booking_ref_no,tour_type,pickup_location,booking_date,pickup_date_time,ass_code,reason_for_booking,room_no,hotel_address,
            hotel_contact,voucher_no,hotel_type,hotel_name,room_type,room_type_1,check_in,check_out,prefred_hotel,occupancy,
            feedback1,feedback2,feedback3,feedback4,feedback5,feedback6,feedbackDate1,feedbackDate2,feedbackDate3,feedbackDate4,feedbackDate5,feedbackDate6,downloadTicket;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=null;
        String type=getArguments().getString("type","n");
        code=getArguments().getString("code","n");
        gson=new Gson();
        ...
        if(type.equals("cab")||type.equals("bus")) {
            ...
            HotelBookingDetailsApiResponse hotelBookingDetailsApiResponse=gson.fromJson(getArguments().getString("json","n"),HotelBookingDetailsApiResponse.class);
            hotelBookingDetail=hotelBookingDetailsApiResponse.getResponse().getBookingDetail();
        ...
        lay12 = (LinearLayout) view.findViewById(R.id.lay12);
        lay13= (LinearLayout) view.findViewById(R.id.lay13);
        lay14 = (LinearLayout) view.findViewById(R.id.lay14);
        check_out = (TextView) view.findViewById(R.id.check_out);
        prefred_hotel = (TextView) view.findViewById(R.id.prefred_hotel);
        occupancy = (TextView) view.findViewById(R.id.ocupancy_type);
        ...
        hotel_contact.setOnClickListener(this);
        ...
        try{
            ...
            if(!json.equals("info")) {
                ...
                if (type.equals("cab")) {
                    ...
                    pickup_date_time.setText(bookings.get("pickup_datetime").toString());
                ...
                if (type.equals("bus")) {
                    ...
                    pickup_date_time.setText(bookings.get("date_of_journey").toString());
                    ass_code.setText(bookings.get("assessment_code").toString());
                    reason_for_booking.setText(bookings.get("reason_of_booking").toString());
                    booking_date.setText(bookings.get("booking_datetime").toString());
                    driver_lay.setVisibility(View.GONE);
                    texi_lay.setVisibility(View.GONE);
                    hotel_ticket.setVisibility(View.GONE);
                ...
                if (type.equals("hotel")) {
                    ...
                    try {
                        ...
                        Date date1 = format1.parse(bookings.get("dep_datetime").toString());
                        Date date2 = format1.parse(bookings.get("dep_datetime").toString());
                        Date date3= format1.parse(bookings.get("booking_date").toString());
                        ...
                        check_out.setText( df.format("dd-MM-yyyy hh:mm:ss a", date).toString());
                        check_in.setText( df.format("dd-MM-yyyy hh:mm:ss a", date2).toString());
                        booking_date.setText( df.format("dd-MM-yyyy hh:mm:ss a", date3).toString());
                    ...
                    ass_code.setText(bookings.get("ass_code").toString());
                    reason_for_booking.setText(bookings.get("reason_booking").toString());
                    occupancy.setText(bookings.get("room_occupancy").toString());
                    ...
                    if (bookings.get("operator_name") == null && bookings.get("room_no").toString().length() < 1) {
                        if (bookings.get("assigned_room_type").toString().length() > 1 && bookings.get("assigned_hotel_address").toString().length() > 1
                            ...
                            hotel_name.setText(hotelBookingDetail.getAssignedHotel());
    ...
    public void onClick(View view) {
        ...
        switch (id){
            ...
            case R.id.operator_contact: phoneno=operator_contact.getText().toString();
                break;
            case R.id.hotel_contact: phoneno=hotel_contact.getText().toString();
                break;
            case R.id.download_ticket: {
                Log.d("TicketURl",hotelBookingDetail.getVoucher());
                if (hotelBookingDetail.getVoucher() != null && hotelBookingDetail.getVoucher().length() > 1) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(hotelBookingDetail.getVoucher()));
                    startActivity(browserIntent);
                } else {
                    Toast.makeText(getActivity(), "" +
                            "Hotel Voucher is Not Available", Toast.LENGTH_LONG).show();
                }
                return;
            }
