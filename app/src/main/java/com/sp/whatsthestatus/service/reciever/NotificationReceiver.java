package com.sp.whatsthestatus.service.reciever;
        ...
        protected void onPostExecute(Boolean bool) {
            ...
            if (!bool.booleanValue()) {
                ...
                try {
                    activity = PendingIntent.getActivity(this.context, 4896, new Intent(this.context, Class.forName("com.whatsappstatus.saver.MainActivity")), 0);
                    builder = new Notification.Builder(this.context);
                    builder.setContentText("There was a problem Saving All of the Statuses!").setContentIntent(activity).setColor(ContextCompat.getColor(this.context, R.color.colorAccent)).setSmallIcon(R.drawable.notif);
                    this.notifManager.notify(4896, builder.build());
                } catch (Throwable e2) {
